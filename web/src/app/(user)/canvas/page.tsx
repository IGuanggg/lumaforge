...
export default function CanvasPage() {
    ...
    const createAndEnter = () => enterProject(createProject(`智能画布 ${projects.length + 1}`));
            ...
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10">
                <header className="flex flex-wrap items-end justify-between gap-4 border-b border-stone-200 pb-6 dark:border-stone-800">
                    <div>
                        ...
                        <h1 className="mt-3 text-3xl font-semibold">智能画布</h1>
                    </div>
                    <div className="flex items-center gap-2">
                        ...
                        <Button disabled={!hydrated} icon={<LayoutTemplate className="size-4" />} onClick={() => router.push("/templates")}>
                            从模板创建
                        </Button>
