...
Ҳ������ GitHub Actions �ֶ����� `Build macOS Release` workflow������ `v2.0.26` tag ʱ���� workflow ���� macOS runner �Ϲ������� macOS zip �ϴ��� GitHub Release��
...
xcrun notarytool submit "releases/LumaForge-2.0.26-macos.zip" --keychain-profile "notarytool-profile" --wait
```
