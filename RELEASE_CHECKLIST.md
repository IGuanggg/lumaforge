...
- Confirm 2.0.7 cache-busted entries load the current GPT 对话, 细节增强, 无限画布, and 素材库 pages.
...
```bash
docker buildx build --platform linux/amd64,linux/arm64 -f Dockerfile.cloud -t iguang9881/lumaforge-cloud:2.0.7 -t iguang9881/lumaforge-cloud:latest --push .
```
