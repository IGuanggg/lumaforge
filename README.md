...
docker buildx build --platform linux/amd64,linux/arm64 \
  -f Dockerfile.cloud \
  -t iguang9881/lumaforge-cloud:2.0.4 \
...
docker pull iguang9881/lumaforge-cloud:2.0.4
...
docker run -d \
  ...
  -e CLOUD_APP_VERSION=2.0.4 \
  -p 127.0.0.1:8787:8787 \
  -v /opt/lumaforge-cloud/cloud-data:/app/data \
  iguang9881/lumaforge-cloud:2.0.4
```
...
```powershell
.\scripts\check_release.ps1 -Version 2.0.4
```
