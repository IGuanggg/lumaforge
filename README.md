...
| 版本 | 说明 | 大小 |
|------|------|------|
| [桌面窗口版](https://github.com/IGuanggg/Infinite-Canvas/releases/download/v1.0.3/Infinite.Canvas.Desktop.zip) | 独立窗口，无终端，推荐正式使用 | ~27 MB |
| [浏览器版](https://github.com/IGuanggg/Infinite-Canvas/releases/download/v1.0.3/Infinite.Canvas.Browser.zip) | 打开浏览器，有终端窗口，推荐调试 | ~22 MB |
...
# → {"name":"infinite-canvas-cloud","version":"1.0.3"}
```
